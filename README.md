...
---
## Generative AI Claimer

1. This README.md was entirely generated by Claude Code (with the exception of this section). Any text or commentary in *_bold italic_* is the author. 

2. The code and build configuation files were created by a human. There are snippets here and there that were improved by consulting with OpenAI or Anthropic generative tools (for example, the implementation of the mutation observer snippet in the Conveyor object). 

3. All JSDoc-formatted inline documentation is generated by Claude Code.

4. All tests generated by Claude Code.

5. Claude Code used a Claude Skill/Agenic Skill that was trained on the code base. The relevant skill files are checked in to the repo in the .claude directory.
